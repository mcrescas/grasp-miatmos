...
install-python: $(BUILD_DIR)
	pip3 install --upgrade 'git+ssh://git@code.grasp-open.com/grasp-tools/grasp-universe.git@master#egg=grasp-retrieval&subdirectory=grasp-code'
