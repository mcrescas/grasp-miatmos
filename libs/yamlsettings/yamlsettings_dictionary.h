...
struct yamlsettings_parameter_{
    const char *name;
    void *mem_pos;
...
// Return the number of values that are set (understanding 'set' as different from default value)
 ...
 */
int yamlsettings_dictionary_dump_recursive(char *r, yamlsettings_dictionary_t *dictionary,int level, int ilevelstart, int indexes[YAMLSETTINGS_MAX_PARAMETER_DIMENSIONS], int indexstop, bool print_defaults, bool force_arrays);
