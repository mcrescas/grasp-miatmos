...
// The parameter is an integer in a strict range. Argument 1=min. Argument 2=max. Value is valid if in [min,max]
...
// The parameter is an integer in a non strict range. Argument 1=min. Argument 2=max. Value is valid if in (min,max)
