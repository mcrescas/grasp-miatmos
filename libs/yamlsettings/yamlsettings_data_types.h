...
typedef char *(*yamlsettings_data_type_get)(void *mem_pos,int position, int nelements, bool escape);
...
char *yamlsettings_data_type_get_string(yamlsettings_data_type_get function_type_get,void *mem_pos,int position, int nelements, bool escape);
...
#define YS_DATA_TYPE_CHAR yamlsettings_data_type_char_set,yamlsettings_data_type_char_get,-1
...
// Path to the internal files. Same as folder path, but the value is changed to the default value if it doesn't exist
#define YS_DATA_TYPE_INTERNAL_FILES_PATH(L) yamlsettings_data_type_internal_files_set,yamlsettings_data_type_folder_path_get,L
