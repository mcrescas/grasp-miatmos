...
#define YAMLSETTINGS_DEFAULTS_MAX_ARGUMENTS 6
#define YAMLSETTINGS_DEFAULTS_MAX_ARGUMENT_SIZE 500

#define DEFAULT_INTERNAL_FILES RESOURCES_PREFIX"/kernels/"
...
/**
 * This set default function set all position as increasing array of integers starting with first argument received.
 * For example, first argument 0, then values assigned are 0,1,2,3,4...
 * For example, first argument 1, then values assigned are 1,2,3,4,5...
 * @param param_index
 * @param parameter
 * @param status
 * @return 
