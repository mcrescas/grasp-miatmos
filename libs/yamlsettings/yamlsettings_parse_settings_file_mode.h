...
// If YS_PARSE_SETTINGS_INLINE first argument has the content of the settings file in a string (inline yaml file)
typedef enum  { YS_PARSE_SETTINGS_FILE_MANDATORY , YS_PARSE_SETTINGS_FILE_FORBIDDEN, YS_PARSE_SETTINGS_FILE_OPTIONAL, YS_PARSE_SETTINGS_INLINE } yamlsettings_parser_settings_file_mode;
