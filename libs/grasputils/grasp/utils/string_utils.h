...
/**
 * This function return an array of strings from a tokenized one.
 * @param line Input string tokenizer
 * @param sep Token or list of tokens (e.g. " \t")
 * @param count Return number of tokens founds. If it is null is ignored.
