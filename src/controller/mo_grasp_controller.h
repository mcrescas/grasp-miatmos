 ...
 */
extern int grasp_init_inversion(retr_input *RIN);
 ...
 * @return 0 if the inversion process finish properly. -1 in case there is an error but it is related with this specific segment. -2 in case there is an error and all segments are going to be erroneous (abort process)
 */
