 ...
 *
 * The behavior of GRASP control unit can be extended through external functions
...
typedef struct grasp_processing_functions_t_{
    ...
    int niteration_output_functions; /**< @brief Number of extension function to print the output of every iteration of the retrieval */   
    grasp_output_segment_function_t *iteration_output_functions; /**< @brief  Output segment function pointers that will be use for the iterations output */
