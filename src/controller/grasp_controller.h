...
extern grasp_output_stream *grasp_controller_get_trackmem_stream();
 ...
 * @param Settings structure allocated and filled 
 * @return 0 if the process was successfull
 */
 ...
 * @return negative if error otherwise 0 or positive.
 */
 ...
 * @param results Result structure will be filled with results from retrievals
 * @param functions extension functions will be called during the process
 * @param segments It is an output argument, if it is different than null it will be used to save each input segment generated by the driver
 * @return negative if error otherwise 0 or positive.
 */
 ...
 * @param functions Extension functions
  * @return 0 if the process finished properly, otherwise negative value
 */
