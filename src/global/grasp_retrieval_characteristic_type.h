...
#define par_type_SD_MD  10121   // aerosol_model_concentration
...
#define par_type_TM_C  10602  //Transport model concentrations
...
#define par_type_TM_H  10703 // Transport model level hights   
#define par_type_ADD_end 10800
    
// Relative
#define par_type_RH_beg  10800
#define par_type_RH  10801    // Relative humidity
#define par_type_TM_RH 10802  // Transport model: Values of vertically dependent relative humidity
#define par_type_RH_end  10900
...
#define par_type_SURF_water_Cox_Munk_iso_2par  20304
#define par_type_SURF_water_Morel  20305
#define par_type_SURF_water_end  20400

#define par_type_surface_end 30000

// Gas concentration parameter
#define par_type_gas_concentration_beg  30000
#define par_type_gas_concentration_1    30101
#define par_type_gas_concentration_2    30201
#define par_type_gas_concentration_3    30301
#define par_type_gas_concentration_4    30401
#define par_type_gas_concentration_5    30501
#define par_type_gas_concentration_6    30601
#define par_type_gas_concentration_7    30701
#define par_type_gas_concentration_8    30801
#define par_type_gas_concentration_9    30901
#define par_type_gas_concentration_10   31001
#define par_type_gas_concentration_end  40000

    
// User defined parametres. They allow to hack the code and let some space for random numbers
#define par_type_USER_defined_beg 90000
#define par_type_USER_defined_1 90100
#define par_type_USER_defined_2 90200
#define par_type_USER_defined_3 90300  
#define par_type_USER_defined_end 100000
