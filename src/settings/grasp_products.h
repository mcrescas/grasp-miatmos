...
//  Output products                 
      ...
      typedef struct output_segment_products_gases_ {
         bool absorption;
         bool concentration;
      } output_segment_products_gases;

      typedef struct output_segment_products_surface_ {
         bool surf;
         bool bhr_iso; // isotropic bihemispherical reflectance
      ...
      typedef struct output_segment_products_errest_particles_ {
         bool mic;       // MEH: for sd when it is not part of the retireved param
         bool opt;        // ext ssa aext
         bool lidar;      // lr     
