...
// Name(s) of the variable which contains the size of a pointer
#define DIMS(d)
/*
 * Example Usage:
 * float *sza DIMS("wln");
 *
 * This tells the python C parser that the sza array has a size dependent on the number of wavelengths.
 * The list of all available dimension shortcuts (like "wln") is in grasp/src/python/output/output_structures.py
 * in the DimensionLookup class. There you can also find the information on how those values are resolved.
 *
 * Oftentimes an array which should be indexed in a two dimensional way is stored as flat, one dimensional array here
 * in memory. In that case the argument in DIMS() should look something like "(wln nsd)" which means that those two
 * values together constitute the array size (wln * nsd) and indexing from python will work in a 2D way
 *
 * Also sometimes a pointer to an object doesn't mean it is an array, just that it is a reference to a single instance,
 * which could also be null. In that case don't specify any DIMS, which will mark that field as size 1 and nullable
 */
  ...
  typedef struct grasp_output_tile_pixel_information_ {
        ...
        int file_index;
        float masl;
        float *sza DIMS("wln"); /**< @brief [wln] */
        float *hvp DIMS("nhvp"); /**< @brief [nhvp] */
  }grasp_output_tile_pixel_information;
  
  typedef struct grasp_output_tile_retrieval_res_{
      int niter;
      float rest;
      float *resa DIMS("nnoises"); //[nnoises]
      float *resr DIMS("nnoises"); //[nnoises]
  }grasp_output_tile_retrieval_res;

  typedef struct grasp_output_tile_retrieval_par_{
      float *parameters DIMS("npars"); //[npars]
      float *sd DIMS("(sd_modes sd_bins)"); // [_KSD+1][4*_KIDIM3] Retrieved SD values: index=0 for total SD
  ...
  typedef struct grasp_output_tile_aerosol_opt_{
      float Aexp;
      float *extt DIMS("wln");  /**< @brief [wln] */
      float *ssat DIMS("wln");  /**< @brief [wln] */
      float *aextt DIMS("wln"); /**< @brief [wln] */
      float *ext DIMS("(wln nsd)");   /**< @brief [wln][nsd] */
      float *ssa DIMS("(wln nsd)");   /**< @brief [wln][nsd] */
      float *aext DIMS("(wln nsd)");  /**< @brief [wln][nsd] */
  }grasp_output_tile_aerosol_opt;

  typedef struct grasp_output_tile_aerosol_rind_{
      float *mreal DIMS("(wln nsd)"); /**< @brief [wln][nsd] */
      float *mimag DIMS("(wln nsd)"); /**< @brief [wln][nsd] */
  }grasp_output_tile_aerosol_rind;

  typedef struct grasp_output_tile_aerosol_phmx_{
      float *ph11 DIMS("(wln nsd nmpar)"); /**< @brief [wln][nsd][nmpar] */
      float *ph12 DIMS("(wln nsd nmpar)"); /**< @brief [wln][nsd][nmpar] */
      float *ph22 DIMS("(wln nsd nmpar)"); /**< @brief [wln][nsd][nmpar] */
      float *ph33 DIMS("(wln nsd nmpar)"); /**< @brief [wln][nsd][nmpar] */
      float *ph34 DIMS("(wln nsd nmpar)"); /**< @brief [wln][nsd][nmpar] */
      float *ph44 DIMS("(wln nsd nmpar)"); /**< @brief [wln][nsd][nmpar] */
      float *pht11 DIMS("(wln nmpar)"); /**< @brief [wln][nmpar] */
      float *pht12 DIMS("(wln nmpar)"); /**< @brief [wln][nmpar] */
      float *pht22 DIMS("(wln nmpar)"); /**< @brief [wln][nmpar] */
      float *pht33 DIMS("(wln nmpar)"); /**< @brief [wln][nmpar] */
      float *pht34 DIMS("(wln nmpar)"); /**< @brief [wln][nmpar] */
      float *pht44 DIMS("(wln nmpar)"); /**< @brief [wln][nmpar] */
  }grasp_output_tile_aerosol_phmx;

  typedef struct grasp_output_tile_aerosol_lidar_{
      float *lr DIMS("(wln nsd)");    /**< @brief [wln][nsd] */
      float *ldpar DIMS("(wln nsd)");  /**< @brief [wln][nsd] */
      float *ldper DIMS("(wln nsd)");  /**< @brief [wln][nsd] */
      float *lrt DIMS("wln");   /**< @brief [wln] */
      float *ldprt DIMS("wln"); /**< @brief [wln] */
  ...
  typedef struct grasp_output_tile_aerosol_sd2m_ext_{
      float *ext DIMS("(wln 2)");   /**< @brief [wln][2] */
  }grasp_output_tile_aerosol_sd2m_ext;

  typedef struct grasp_output_tile_aerosol_chem_{
      float *rh DIMS("nsd");      /**< @brief [nsd] */
      float *fwrt DIMS("nsd");    /**< @brief [nsd] */
      float *fslbl DIMS("nsd");   /**< @brief [nsd] */
      float *vfract DIMS("(nsd N_CHEM_MAX)"); /**< @brief [nsd] */
  }grasp_output_tile_aerosol_chem;

  typedef struct grasp_output_tile_aerosol_pm_{
      float *pm DIMS("nPM_diam");  /**< @brief [nPM_diam] */
  ...
  typedef struct grasp_output_tile_surface_surf_{
      float ndvi;
      float *dhr DIMS("wln"); /**< @brief [nwl] */
      float *bhr_iso DIMS("wln"); /**< @brief [nwl] */
  }grasp_output_tile_surface_surf;

  typedef struct grasp_output_tile_errest_par_{
      float *ERRP DIMS("npars"); /**< @brief [npars] */
      float *BIASP DIMS("npars"); /**< @brief [npars] */
      float *TSTDP DIMS("npars"); /**< @brief [npars] */
      float *sd_err DIMS("(sd_modes sd_bins)"); /**< @brief [KSD+1][4*_KIDIM3] */
  }grasp_output_tile_errest_par;

  typedef struct grasp_output_tile_errest_aerosol_opt_{
      float *ERR_ext DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *BIAS_ext DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *TSTD_ext DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *ERR_extt DIMS("wln"); /**< @brief [nwl] */
      float *BIAS_extt DIMS("wln"); /**< @brief [nwl] */
      float *TSTD_extt DIMS("wln"); /**< @brief [nwl] */
      float *ERR_ssa DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *BIAS_ssa DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *TSTD_ssa DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *ERR_ssat DIMS("wln"); /**< @brief [nwl] */
      float *BIAS_ssat DIMS("wln");  /**< @brief [nwl] */
      float *TSTD_ssat DIMS("wln");  /**< @brief [nwl] */
      float *ERR_aext DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *BIAS_aext DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *TSTD_aext DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *ERR_aextt DIMS("wln"); /**< @brief [nwl] */
      float *BIAS_aextt DIMS("wln");  /**< @brief [nwl] */
      float *TSTD_aextt DIMS("wln");  /**< @brief [nwl] */
  }grasp_output_tile_errest_aerosol_opt;

  typedef struct grasp_output_tile_errest_aerosol_lidar_{
      float *ERR_lr DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *BIAS_lr DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *TSTD_lr DIMS("(wln nsd)"); /**< @brief [nwl][nsd] */
      float *ERR_lrt DIMS("wln"); /**< @brief [nwl] */
      float *BIAS_lrt DIMS("wln"); /**< @brief [nwl] */
      float *TSTD_lrt DIMS("wln"); /**< @brief [nwl] */
  }grasp_output_tile_errest_aerosol_lidar;

// MEH:
typedef struct grasp_output_tile_errest_aerosol_mic_{
    float *ERR_sdt DIMS("sd_bins"); /**< @brief [4*_KIDIM3] */
    float *BIAS_sdt DIMS("sd_bins"); /**< @brief [4*_KIDIM3] */
    float *TSTD_sdt DIMS("sd_bins"); /**< @brief [4*_KIDIM3] */
}grasp_output_tile_errest_aerosol_mic;

  typedef struct grasp_output_tile_forcing_bbflux_{
      int nhlv;
      float *bbufx0 DIMS("nhlv");  /**< @brief [nhlv] */
      float *bbdfx0 DIMS("nhlv"); /**< @brief [nhlv] */
      float *bbufxa DIMS("nhlv"); /**< @brief [nhlv] */
      float *bbdfxa DIMS("nhlv"); /**< @brief [nhlv] */
      float *hlv DIMS("nhlv"); /**< @brief [nhlv] */
  }grasp_output_tile_forcing_bbflux;


  typedef struct grasp_output_tile_forcing_forcing_{
        int   nhlv;
        float *netforc DIMS("nhlv");   /**< @brief [nhlv] */
        float *forceff DIMS("nhlv");   /**< @brief [nhlv] */
        float *hlv DIMS("nhlv"); /**< @brief [nhlv] */
  }grasp_output_tile_forcing_forcing;
  
  
  typedef struct grasp_output_tile_gases_{
        float *absorption DIMS("(wln gases)");   /**< @brief [nwl][settings->retrieval.gases.nlut_name+1] */
  ...
  typedef struct grasp_output_tile_retrieval_information_{
        ...
        int nhvp; // from nvbm  (index for grasp_output_tile_pixel_information.hvp)
        int ngases; 
  ...
  typedef struct grasp_results_t_{
        ...
        grasp_output_tile_segment_result_t *segment_result DIMS("(seg_t seg_col seg_row)");   // dimensions [t, x, y ] [itime,icol,irow]
        sensor_data_t **segment_original DIMS("(seg_t seg_col seg_row)");
        sensor_data_t **segment_fit DIMS("(seg_t seg_col seg_row)");
        grasp_output_tile_retrieval_information information;
        pixel_result_t **tile_result_map DIMS("(t x y)");  // dimensions [t, x, y ] [itime,icol,irow]. results reindexed
    }grasp_results_t;

  /**
  * This structure manage the results of GRASP in case they want to be used outside
  * GRASP code itself, for instance: from python interface.
  */
  typedef struct grasp_results_description_{
 ...
 * @return Value of the wavelenght in nanometers
 */
 ...
 * @param ix X index of the pixel in the tile
 * @param iy Y index of the pixel in the tile
 * @return seconds taken to process the pixel
 */
 ...
 * Number of vertical points in the pixel
 * @param output Output of retrieval from a tile
 * @param it Time index of the pixel in the tile
 * @param ix X index of the pixel in the tile
 * @param iy Y index of the pixel in the tile
 * @return Number of vertical points in vertical profile
 */
 ...
 * @return Value in meter of vertical range
 */
 ...
 * @param ix X index of the pixel in the tile
 * @param iy Y index of the pixel in the tile
 * @return radii points for specific mode (0=total)
 */
...
/**
 * DEPRECATED: used instead: int grasp_output_tile_information_nhvp(const grasp_results_t *output,int it, int ix, int iy);
 * Values of levels (in meters!) for forcing and flux
 * @param output Output of retrieval from a tile
 * @param it Time index of the pixel in the tile
 * @param ix X index of the pixel in the tile
 * @param iy Y index of the pixel in the tile
 ...
 * @return retrieved value of the bin of SD
 */
 ...
 * @param ix X index of the pixel in the tile
 * @param iy Y index of the pixel in the tile
 * @return Original pixel data. It is the pixel in sdata input information
 */
 ...
 * @param ix X index of the pixel in the tile
 * @param iy Y index of the pixel in the tile
 * @return It is like sdata but filled with fitting information
 */
 ...
 * @param ix X index of the pixel in the tile
 * @param iy Y index of the pixel in the tile
 * @return It is the sdata input information
 */
 ...
 * @param iy Y index of the pixel in the tile
 * @param isd Index of aerosol component
 * @param ichem Index of chemistry component
 * @return  insoluble fraction for aerosol optical properties
 */
...
/*
 * Return error of retrieved size distribution simplified for easy interpretation
