...
!	------------------------------------------------------------------------------------------
      ...
      type(segment_edges),        intent(inout) ::  edges
!	------------------------------------------------------------------------------------------
      integer ::  II_E,IT_E,IX,IY,IT,ipix,npar
...
!	------------------------------------------------------------------------------------------      
      ...
      open (newunit=iEDGE_input, FILE=trim(internal_file_path)//"input_edge.dat",status='old')
...
!	------------------------------------------------------------------------------------------
      integer ::  i,II_E,IX,IY,IT,it_counter
      integer ::  N_I_EDGE,I_EDGE(6)
      integer ::  nx_edge_max,ny_edge_max,nt_edge_max
      integer ::  nt_temp
      !integer ::  nx_temp,ny_temp
