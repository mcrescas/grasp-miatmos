...
!PL Therefore, we take:		
      ...
      INTEGER, PARAMETER ::   NG_SPEC_RANGE_MAX = _NG_SPEC_RANGE_MAX
      INTEGER, PARAMETER ::   N_P_GLUT_MAX      = _N_P_GLUT_MAX
      INTEGER, PARAMETER ::   N_T_GLUT_MAX      = _N_T_GLUT_MAX
      INTEGER, PARAMETER ::   N_WL_GLUT_MAX     = _N_WL_GLUT_MAX
      INTEGER, PARAMETER ::   N_WL_CHANNEL_MAX  = _N_WL_CHANNEL_MAX
      INTEGER, PARAMETER ::   N_SUB_CHANNEL_MAX = _N_SUB_CHANNEL_MAX
      INTEGER, PARAMETER ::   N_FILTERS_MAX     = _N_FILTERS_MAX
      INTEGER, PARAMETER ::   N_CHEM_MAX        = _N_CHEM_MAX
      INTEGER, PARAMETER ::   N_RR_MAX          = _N_RR_MAX
