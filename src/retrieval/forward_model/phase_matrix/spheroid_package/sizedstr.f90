...
!c **  Write into 'LNPAR.dat'
      ...
      IF (ISD.EQ.2) WRITE(7,*) 'second component:'
       ...
       ENDDO
!
! AAR(ISD,I1) - concentration due to limit: Rmin-Rmax
!
       WRITE(7,*) (ACR(ISD,I1)-AAR(ISD,I1))/ACR(ISD,I1),   &
      'relative error in concentration due to limit: Rmin-Rmax'
!WRITE(*,*) i1, ACR(ISD,I1), AAR(ISD,I1), (ACR(ISD,I1)-AAR(ISD,I1))/ACR(ISD,I1),   &
!'i1, ACR(ISD,I1), AAR(ISD,I1), relative error in concentration due to limit: Rmin-Rmax'
!
! AAR(ISD,I1) - 
!
      ENDDO ! ISD
     ...
     CLOSE (7)
      ...
      DO ISD=1,NSD
      !AC(ISD)=ACR(ISD,3)
      AC(ISD)=AAR(ISD,3) ! concentration for limit: Rmin-Rmax'
       DO I=1,KNN(ISD)
