...
typedef intptr_t fptr; // F. Ducos: replace long long int with the more portable intptr_t from C99 (works on 32 and 64 bit arch)
...
//#define SUPERLU_INFO // uncomment this to display the information below
#ifdef SUPERLU_INFO
    SCformat *Lstore;
    NCformat *Ustore;
#endif /* SUPERLU_INFO */
